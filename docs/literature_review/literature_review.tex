...
To explicitly justify the technical selection, Table~\ref{tab:method-comparison} summarizes the strengths, limitations, and suitability of the discussed chatbot approaches.
